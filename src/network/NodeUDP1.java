...
public class NodeUDP1 {
	...
	File file_rx = null;
	final static File notify_file = new File("./tmp/nat.notify");
	final static File notify_rfile = new File("./tmp/natr.notify");
