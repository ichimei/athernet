...
/* This algorithm is from Stack Overflow:
...
public class CRC8 implements Checksum
{
    ...
    public static void  main(String[] args)
    {
        ...
        final byte[] data = {1, 56, -23, 3, 0, 19, 0, 0, 2, 10, 17, 13, 8, -34, 7, 9, 42, 18, 26, -5, 54, 11, -94, -46, -128, 4, 48, 52, 0, 0, 0, 0, 0, 0, 0, 0, 4, 1, 1, -32, -80, 0, 98, -5, 71, 0, 64, 0, 0, 0, 0, -116, 1, 104, 2};
        CRC8 crc8 = new CRC8(CRC_POLYNOM, CRC_INITIAL);
        crc8.update(data,0,data.length);
        System.out.println("Test successful:\t"+(crc8.getValue()));
    }
}
